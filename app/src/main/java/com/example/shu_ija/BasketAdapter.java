...
import static com.example.shu_ija.Basket.addmodecourse;
import static com.example.shu_ija.Basket.addproduit;
import static com.example.shu_ija.Basket.minproduit;
...
public class BasketAdapter extends BaseAdapter {
    ...
    public BasketAdapter(ArrayList<ItemModeCourse> Items ,Context context) {
        this.Items = Items;
