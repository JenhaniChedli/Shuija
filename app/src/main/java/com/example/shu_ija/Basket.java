...
public class Basket extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PrixModel.clear();
        ItemsProducts.addAll(ModeCourse.getitemlist());
        basket.addAll(ModeCourse.getbasket());
        panier.addAll(ModeCourse.getpanier());
        txt_countcard.setText(""+basket.size());
        basketAdapter = new BasketAdapter(basket, getApplicationContext());
    ...
    public void onBackPressed() {
        Intent i = new Intent(getApplicationContext(), ModeCourse.class);
